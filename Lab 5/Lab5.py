...
from ispit import unos_ispita, ispis_ispita, ispis_svih_ispita
from student import unos_studenta, ispis_studenta, ispis_svih_studenta
...
while running:
    print("-"*20)
    print("Unesite broj u intervalu 1-7: ")
